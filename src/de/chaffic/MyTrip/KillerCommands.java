  ...
  implements CommandExecutor
{
  ...
  public final String prefix = ChatColor.RED + "====" + ChatColor.BLACK + "[" + ChatColor.DARK_RED + "Version: 0.1-alpha.1" + ChatColor.BLACK + "]" + ChatColor.RED + "====";
    ...
    if (command.getName().equalsIgnoreCase("mytrip"))
    {
      if (args.length == 0)
      {
        if ((sender instanceof Player))
        {
          ...
          {
            p.sendMessage(ChatColor.RED + "You can use the commands listed below:");
        ...
        {
          sender.sendMessage(ChatColor.RED + "You can use the commands listed below:");
      ...
      else if (args[0].equalsIgnoreCase("remove"))
      {
        ...
        if ((sender instanceof Player))
        {
          ...
          if (p.hasPermission("mytrip.help"))
          {
            ...
            sender.sendMessage(this.dash + ChatColor.GREEN + "Sugar_cane " + ChatColor.WHITE + "(Heroin)");
            sender.sendMessage(this.dash + ChatColor.GREEN + "Red_Mushoom " + ChatColor.WHITE + "(Mushroom)");
          }
          else
          {
            p.sendMessage(this.perm);
