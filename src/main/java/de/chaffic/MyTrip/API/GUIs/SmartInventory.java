...
public class SmartInventory {
    ...
    public Inventory open(Player player, int page) {
        ...
        InventoryOpener opener = this.manager.findOpener(type)
                .orElseThrow(() -> new IllegalStateException("Error 016: No InventoryOpener found for the inventory type " + type.name() + "."));
    ...
    public static final class Builder {
        ...
        public SmartInventory build() {
            if(this.provider == null)
                throw new IllegalStateException("Error 017: The provider of the ChafficInventory.Builder must be set.");

            InventoryManager manager = this.manager != null ? this.manager : plugin.GUIAPI;

            if(manager == null)
                throw new IllegalStateException("Error 018: The manager of the ChafficInventory.Builder must be set.");
